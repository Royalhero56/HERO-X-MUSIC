...
OWNER_USERNAME = getenv("OWNER_USERNAME", "iamcutehero")
BOT_USERNAME = getenv("BOT_USERNAME", "royalhero613bot")
BOT_NAME = getenv("BOT_NAME", "˹ ʜᴇʀᴏ ✘ ᴍᴜsɪᴄ ˼🫧️")
ASSUSERNAME = getenv("ASSUSERNAME", "musicXannie")
ROYALHERO = list(map(int, getenv("ROYALHERO", "6343729323").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Royalhero56/HERO-X-MUSIC")
...
AYUV = [
    "ʜᴇʟʟᴏ {0}, 🥀\n\n ɪᴛ'ꜱ ᴍᴇ {1} !\n\n┏━━━━━━━━━━━━━━━━━⧫\n┠ ◆ ꜱᴜᴘᴘᴏʀᴛɪɴɢ ᴘʟᴀᴛꜰᴏʀᴍꜱ : ʏᴏᴜᴛᴜʙᴇ, ꜱᴘᴏᴛɪꜰʏ,\n┠ ◆ ʀᴇꜱꜱᴏ, ᴀᴘᴘʟᴇᴍᴜꜱɪᴄ , ꜱᴏᴜɴᴅᴄʟᴏᴜᴅ ᴇᴛᴄ.\n┗━━━━━━━━━━━━━━━━━⧫\n┏━━━━━━━━━━━━━━━━━⧫\n┠ ➥ Uᴘᴛɪᴍᴇ : {2}\n┠ ➥ SᴇʀᴠᴇʀSᴛᴏʀᴀɢᴇ : {3}\n┠ ➥ CPU Lᴏᴀᴅ : {4}\n┠ ➥ RAM Cᴏɴsᴜᴘᴛɪᴏɴ : {5}\n┠ ➥ ᴜꜱᴇʀꜱ : {6}\n┠ ➥ ᴄʜᴀᴛꜱ : {7}\n┗━━━━━━━━━━━━━━━━━⧫\n\n🫧 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🪽 ➪ [『➳⃝‌ ̶̶ͥ ̶ ̶ͣ ͓ ̶͓ͫ➣💖⃝𝐇 𝐄 𝐑 𝐎💖 ̶͢ ̶ͨ ̶ͧ ̶ͭ ̶̶ͤͤ➳⃝‌🌍](https://t.me/iamcutehero)",
...
PING_VID_URL = getenv(
    "PING_VID_URL", "https://graph.org/file/8e904425b527cb3045de2.jpg"
)
